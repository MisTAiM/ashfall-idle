  ...
  showHitSplat(d) {
    ...
    if (d.who === 'player') {
      ...
      const PLAYER_ANIMS = {
        ...
        crush:      `<svg viewBox="0 0 80 80"><rect x="30" y="5" width="20" height="12" rx="3" fill="${cc}" opacity="0.8"><animate attributeName="y" from="5" to="55" dur="0.18s" fill="freeze"/><animate attributeName="opacity" from="0.8" to="0" dur="0.15s" begin="0.18s" fill="remove"/></rect><circle cx="40" cy="60" r="0" fill="none" stroke="${cc}" stroke-width="2"><animate attributeName="r" from="5" to="28" dur="0.22s" begin="0.17s" fill="freeze"/><animate attributeName="opacity" from="0.7" to="0" dur="0.22s" begin="0.17s" fill="remove"/></circle></svg>`,
        ...
        bolt:       `<svg viewBox="0 0 80 40"><rect x="5" y="18" width="64" height="4" rx="2" fill="#c4a83a"><animate attributeName="x" from="5" to="74" dur="0.18s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.1s" begin="0.16s" fill="remove"/></rect><circle cx="70" cy="20" r="0" fill="#d4a83a"><animate attributeName="r" from="2" to="10" dur="0.12s" begin="0.16s" fill="freeze"/><animate attributeName="opacity" from="0.8" to="0" dur="0.12s" begin="0.16s" fill="remove"/></circle></svg>`,
        bolt_void:  `<svg viewBox="0 0 80 40"><rect x="5" y="18" width="64" height="4" rx="2" fill="#8a3ab0"><animate attributeName="x" from="5" to="74" dur="0.18s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.1s" begin="0.16s" fill="remove"/></rect><circle cx="70" cy="20" r="0" fill="#d080ff"><animate attributeName="r" from="2" to="14" dur="0.15s" begin="0.14s" fill="freeze"/><animate attributeName="opacity" from="0.9" to="0" dur="0.15s" begin="0.14s" fill="remove"/></circle></svg>`,
        spell_blue: `<svg viewBox="0 0 80 80"><circle cx="40" cy="40" r="3" fill="#6a8ae8" opacity="0.9"><animate attributeName="r" from="3" to="28" dur="0.35s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.35s" fill="remove"/></circle></svg>`,
        spell_gold: `<svg viewBox="0 0 80 80"><circle cx="40" cy="40" r="4" fill="#c4a83a"><animate attributeName="r" from="4" to="26" dur="0.3s" fill="freeze"/><animate attributeName="opacity" from="0.9" to="0" dur="0.3s" fill="remove"/></circle><circle cx="40" cy="40" r="1" fill="#ffd080"><animate attributeName="r" from="1" to="14" dur="0.22s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.25s" fill="remove"/></circle></svg>`,
        spell_void: `<svg viewBox="0 0 80 80"><circle cx="40" cy="40" r="4" fill="#6010c0"><animate attributeName="r" from="4" to="28" dur="0.32s" fill="freeze"/><animate attributeName="opacity" from="0.9" to="0" dur="0.32s" fill="remove"/></circle><circle cx="40" cy="40" r="2" fill="#d080ff"><animate attributeName="r" from="2" to="14" dur="0.24s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.28s" fill="remove"/></circle></svg>`,
        spell_poison:`<svg viewBox="0 0 80 80"><circle cx="40" cy="40" r="4" fill="#2a7a1a"><animate attributeName="r" from="4" to="26" dur="0.32s" fill="freeze"/><animate attributeName="opacity" from="0.8" to="0" dur="0.32s" fill="remove"/></circle><circle cx="40" cy="40" r="2" fill="#6acc2a"><animate attributeName="r" from="2" to="12" dur="0.24s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.28s" fill="remove"/></circle></svg>`,
        spell_blood:`<svg viewBox="0 0 80 80"><circle cx="40" cy="40" r="4" fill="#8a0a0a"><animate attributeName="r" from="4" to="26" dur="0.32s" fill="freeze"/><animate attributeName="opacity" from="0.9" to="0" dur="0.32s" fill="remove"/></circle><circle cx="40" cy="40" r="2" fill="#ff4040"><animate attributeName="r" from="2" to="14" dur="0.24s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.28s" fill="remove"/></circle></svg>`,
        spell_dark: `<svg viewBox="0 0 80 80"><circle cx="40" cy="40" r="4" fill="#1a1a1a"><animate attributeName="r" from="4" to="28" dur="0.32s" fill="freeze"/><animate attributeName="opacity" from="0.85" to="0" dur="0.32s" fill="remove"/></circle><circle cx="40" cy="40" r="2" fill="#a0a0a0"><animate attributeName="r" from="2" to="12" dur="0.24s" fill="freeze"/><animate attributeName="opacity" from="0.9" to="0" dur="0.28s" fill="remove"/></circle></svg>`,
        spell_reality:`<svg viewBox="0 0 80 80"><circle cx="40" cy="40" r="6" fill="#3a0a6a"><animate attributeName="r" from="6" to="38" dur="0.38s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.38s" fill="remove"/></circle><circle cx="40" cy="40" r="3" fill="#9030d0"><animate attributeName="r" from="3" to="20" dur="0.28s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.32s" fill="remove"/></circle><circle cx="40" cy="40" r="1" fill="#e0a0ff"><animate attributeName="r" from="1" to="8" dur="0.18s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.22s" fill="remove"/></circle></svg>`,
      };
    ...
    anim.querySelectorAll('animate').forEach(a => { a.setAttribute('fill','remove'); });
  ...
  _getAbilityAnimSvg(abilityId, effectType) {
    ...
    const ABILITY_ANIMS = {
      power_strike: `<svg viewBox="0 0 160 160" class="ab-anim-svg"><defs><radialGradient id="ps-g" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="#d4a83a" stop-opacity="0.9"/><stop offset="100%" stop-color="#d4a83a" stop-opacity="0"/></radialGradient></defs>
        ...
        <circle cx="80" cy="80" r="0" fill="none" stroke="#d4a83a" stroke-width="4"><animate attributeName="r" from="0" to="70" dur="0.5s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.5s" fill="remove"/></circle>
        <circle cx="80" cy="80" r="0" fill="none" stroke="#ffd080" stroke-width="2"><animate attributeName="r" from="0" to="50" dur="0.35s" fill="freeze"/><animate attributeName="opacity" from="0.8" to="0" dur="0.35s" fill="remove"/></circle>
        <!-- Power slash lines -->
        <path d="M20 140 L80 80 L140 20" stroke="#d4a83a" stroke-width="4" stroke-linecap="round" fill="none"><animate attributeName="stroke-dasharray" from="0 200" to="200 0" dur="0.3s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.4s" begin="0.2s" fill="remove"/></path>
        <path d="M30 120 L80 80 L130 30" stroke="#ffd080" stroke-width="2" fill="none"><animate attributeName="stroke-dasharray" from="0 180" to="180 0" dur="0.28s" fill="freeze"/><animate attributeName="opacity" from="0.7" to="0" dur="0.35s" begin="0.25s" fill="remove"/></path>
        <!-- Impact center -->
        <circle cx="80" cy="80" r="0" fill="url(#ps-g)"><animate attributeName="r" from="0" to="30" dur="0.2s" fill="freeze"/><animate attributeName="opacity" from="0.8" to="0" dur="0.3s" begin="0.1s" fill="remove"/></circle>
      </svg>`,
      ...
      rapid_shot: `<svg viewBox="0 0 160 80" class="ab-anim-svg ab-anim-wide"><g>
        ...
        <circle cx="155" cy="40" r="0" fill="none" stroke="#4a9ed4" stroke-width="2"><animate attributeName="r" from="2" to="20" dur="0.25s" begin="0.2s" fill="freeze"/><animate attributeName="opacity" from="0.8" to="0" dur="0.25s" begin="0.2s" fill="remove"/></circle>
      </g></svg>`,
      ...
      arcane_burst: `<svg viewBox="0 0 160 160" class="ab-anim-svg"><defs><radialGradient id="ab-g" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="#9b30d0" stop-opacity="0.7"/><stop offset="100%" stop-color="#9b30d0" stop-opacity="0"/></radialGradient></defs>
        ...
        <circle cx="80" cy="80" r="0" fill="none" stroke="#9b30d0" stroke-width="5"><animate attributeName="r" from="0" to="75" dur="0.6s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.6s" fill="remove"/></circle>
        <circle cx="80" cy="80" r="0" fill="none" stroke="#c050f0" stroke-width="3"><animate attributeName="r" from="0" to="55" dur="0.45s" fill="freeze"/><animate attributeName="opacity" from="0.9" to="0" dur="0.45s" fill="remove"/></circle>
        <circle cx="80" cy="80" r="0" fill="none" stroke="#e090ff" stroke-width="2"><animate attributeName="r" from="0" to="35" dur="0.3s" fill="freeze"/><animate attributeName="opacity" from="0.8" to="0" dur="0.3s" fill="remove"/></circle>
        <!-- Void core fill -->
        <circle cx="80" cy="80" r="0" fill="url(#ab-g)"><animate attributeName="r" from="0" to="40" dur="0.35s" fill="freeze"/><animate attributeName="opacity" from="0.7" to="0" dur="0.4s" begin="0.1s" fill="remove"/></circle>
        <!-- Rune sparks -->
        <circle cx="80" cy="20" r="0" fill="#c050f0"><animate attributeName="r" from="0" to="5" dur="0.15s" fill="freeze"/><animate attributeName="cy" from="20" to="10" dur="0.3s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.35s" fill="remove"/></circle>
        <circle cx="140" cy="80" r="0" fill="#9b30d0"><animate attributeName="r" from="0" to="4" dur="0.15s" fill="freeze"/><animate attributeName="cx" from="140" to="155" dur="0.3s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.35s" fill="remove"/></circle>
        <circle cx="80" cy="140" r="0" fill="#c050f0"><animate attributeName="r" from="0" to="5" dur="0.15s" fill="freeze"/><animate attributeName="cy" from="140" to="155" dur="0.3s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.35s" fill="remove"/></circle>
        <circle cx="20" cy="80" r="0" fill="#9b30d0"><animate attributeName="r" from="0" to="4" dur="0.15s" fill="freeze"/><animate attributeName="cx" from="20" to="5" dur="0.3s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.35s" fill="remove"/></circle>
      </svg>`,
      ...
      shield_wall: `<svg viewBox="0 0 160 160" class="ab-anim-svg"><defs><radialGradient id="sw-g" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="#4a7ec4" stop-opacity="0.4"/><stop offset="100%" stop-color="#4a7ec4" stop-opacity="0"/></radialGradient></defs>
        <!-- Shield shimmer fill -->
        <circle cx="80" cy="80" r="0" fill="url(#sw-g)"><animate attributeName="r" from="0" to="75" dur="0.4s" fill="freeze"/><animate attributeName="opacity" from="0.8" to="0" dur="0.6s" begin="0.2s" fill="remove"/></circle>
        <!-- Hex shield pattern -->
        <path d="M80 20 L130 50 L130 110 L80 140 L30 110 L30 50Z" fill="none" stroke="#4a7ec4" stroke-width="3"><animate attributeName="opacity" from="0" to="0.8" dur="0.2s" fill="freeze"/><animate attributeName="opacity" from="0.8" to="0" dur="0.5s" begin="0.3s" fill="remove"/></path>
        <path d="M80 35 L115 55 L115 105 L80 125 L45 105 L45 55Z" fill="none" stroke="#6a9ee4" stroke-width="1.5"><animate attributeName="opacity" from="0" to="0.6" dur="0.2s" fill="freeze"/><animate attributeName="opacity" from="0.6" to="0" dur="0.5s" begin="0.3s" fill="remove"/></path>
        <!-- Blue shimmer lines -->
        <line x1="30" y1="80" x2="130" y2="80" stroke="#4a7ec4" stroke-width="1"><animate attributeName="opacity" from="0" to="0.5" dur="0.15s" fill="freeze"/><animate attributeName="opacity" from="0.5" to="0" dur="0.4s" begin="0.25s" fill="remove"/></line>
        <line x1="80" y1="20" x2="80" y2="140" stroke="#4a7ec4" stroke-width="1"><animate attributeName="opacity" from="0" to="0.5" dur="0.15s" fill="freeze"/><animate attributeName="opacity" from="0.5" to="0" dur="0.4s" begin="0.25s" fill="remove"/></line>
      </svg>`,
      ...
      battle_cry: `<svg viewBox="0 0 160 160" class="ab-anim-svg"><defs><radialGradient id="bc-g" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="#c44040" stop-opacity="0.6"/><stop offset="100%" stop-color="#c44040" stop-opacity="0"/></radialGradient></defs>
        <!-- Red explosion rings -->
        <circle cx="80" cy="80" r="0" fill="url(#bc-g)"><animate attributeName="r" from="0" to="80" dur="0.4s" fill="freeze"/><animate attributeName="opacity" from="0.7" to="0" dur="0.5s" fill="remove"/></circle>
        <circle cx="80" cy="80" r="0" fill="none" stroke="#c44040" stroke-width="5"><animate attributeName="r" from="0" to="75" dur="0.45s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.45s" fill="remove"/></circle>
        <circle cx="80" cy="80" r="0" fill="none" stroke="#ff6040" stroke-width="3"><animate attributeName="r" from="0" to="55" dur="0.32s" fill="freeze"/><animate attributeName="opacity" from="0.8" to="0" dur="0.32s" fill="remove"/></circle>
        <!-- Burst lines outward -->
        <line x1="80" y1="80" x2="80" y2="10"><animate attributeName="y2" from="80" to="8" dur="0.3s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.35s" fill="remove"/> stroke="#c44040" stroke-width="2.5"/></line>
        <line x1="80" y1="80" x2="150" y2="80" stroke="#c44040" stroke-width="2.5"><animate attributeName="x2" from="80" to="152" dur="0.3s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.35s" fill="remove"/></line>
        <line x1="80" y1="80" x2="80" y2="150" stroke="#c44040" stroke-width="2.5"><animate attributeName="y2" from="80" to="152" dur="0.3s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.35s" fill="remove"/></line>
        <line x1="80" y1="80" x2="10" y2="80" stroke="#c44040" stroke-width="2.5"><animate attributeName="x2" from="80" to="8" dur="0.3s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.35s" fill="remove"/></line>
      </svg>`,
      ...
      void_step: `<svg viewBox="0 0 160 160" class="ab-anim-svg"><defs><radialGradient id="vs-g" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="#1a0a2a" stop-opacity="0.9"/><stop offset="60%" stop-color="#5a0a9a" stop-opacity="0.4"/><stop offset="100%" stop-color="#9b30d0" stop-opacity="0"/></radialGradient></defs>
        ...
        <circle cx="80" cy="80" r="75" fill="none" stroke="#9b30d0" stroke-width="3"><animate attributeName="r" from="75" to="5" dur="0.35s" fill="freeze"/><animate attributeName="opacity" from="0.8" to="0" dur="0.4s" fill="remove"/></circle>
        <circle cx="80" cy="80" r="60" fill="none" stroke="#6a0aaa" stroke-width="2"><animate attributeName="r" from="60" to="3" dur="0.28s" fill="freeze"/><animate attributeName="opacity" from="0.6" to="0" dur="0.32s" fill="remove"/></circle>
        <!-- Void center flash -->
        <circle cx="80" cy="80" r="0" fill="url(#vs-g)"><animate attributeName="r" from="0" to="60" dur="0.2s" begin="0.3s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.3s" begin="0.3s" fill="remove"/></circle>
        <!-- Afterimage lines -->
      ...
      blood_frenzy: `<svg viewBox="0 0 160 160" class="ab-anim-svg"><defs><radialGradient id="bf-g" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="#8a0a0a" stop-opacity="0.6"/><stop offset="100%" stop-color="#c44040" stop-opacity="0"/></radialGradient></defs>
        <!-- Blood splatter -->
        <circle cx="80" cy="80" r="0" fill="url(#bf-g)"><animate attributeName="r" from="0" to="70" dur="0.3s" fill="freeze"/><animate attributeName="opacity" from="0.8" to="0" dur="0.5s" begin="0.1s" fill="remove"/></circle>
        <!-- Drip lines -->
        <path d="M80 80 L60 30"><animate attributeName="d" from="M80 80 L80 80" to="M80 80 L60 20" dur="0.3s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.4s" fill="remove"/> stroke="#c44040" stroke-width="2"/></path>
        <path d="M80 80 L120 50" stroke="#c44040" stroke-width="2"><animate attributeName="d" from="M80 80 L80 80" to="M80 80 L130 40" dur="0.28s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.4s" fill="remove"/></path>
        <path d="M80 80 L40 110" stroke="#8a0a0a" stroke-width="2"><animate attributeName="d" from="M80 80 L80 80" to="M80 80 L30 120" dur="0.32s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.4s" fill="remove"/></path>
        <path d="M80 80 L110 130" stroke="#c44040" stroke-width="2"><animate attributeName="d" from="M80 80 L80 80" to="M80 80 L120 145" dur="0.25s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.4s" fill="remove"/></path>
        <!-- Blood drops -->
        <circle cx="80" cy="80" r="6" fill="#c44040"><animate attributeName="r" from="6" to="2" dur="0.2s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.3s" begin="0.15s" fill="remove"/></circle>
      </svg>`,
      ...
      ash_nova: `<svg viewBox="0 0 160 160" class="ab-anim-svg"><defs>
        ...
        <circle cx="80" cy="80" r="0" fill="url(#an-g)"><animate attributeName="r" from="0" to="80" dur="0.5s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.6s" begin="0.1s" fill="remove"/></circle>
        <!-- Multiple rings -->
        <circle cx="80" cy="80" r="0" fill="none" stroke="#ff6020" stroke-width="6"><animate attributeName="r" from="0" to="78" dur="0.55s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.55s" fill="remove"/></circle>
        <circle cx="80" cy="80" r="0" fill="none" stroke="#c9873e" stroke-width="4"><animate attributeName="r" from="0" to="60" dur="0.42s" fill="freeze"/><animate attributeName="opacity" from="0.9" to="0" dur="0.42s" fill="remove"/></circle>
        <circle cx="80" cy="80" r="0" fill="none" stroke="#ffd080" stroke-width="2"><animate attributeName="r" from="0" to="40" dur="0.28s" fill="freeze"/><animate attributeName="opacity" from="0.8" to="0" dur="0.28s" fill="remove"/></circle>
        <!-- Ember sparks burst outward -->
        <circle cx="80" cy="80" r="3" fill="#ffd080"><animate attributeName="cy" from="80" to="10" dur="0.45s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.5s" fill="remove"/></circle>
        <circle cx="80" cy="80" r="3" fill="#ff6020"><animate attributeName="cx" from="80" to="150" dur="0.42s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.5s" fill="remove"/></circle>
        <circle cx="80" cy="80" r="3" fill="#ffd080"><animate attributeName="cy" from="80" to="150" dur="0.45s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.5s" fill="remove"/></circle>
        <circle cx="80" cy="80" r="3" fill="#ff6020"><animate attributeName="cx" from="80" to="10" dur="0.42s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.5s" fill="remove"/></circle>
        <circle cx="80" cy="80" r="2" fill="#c9873e"><animate attributeName="cx" from="80" to="145" dur="0.38s" fill="freeze"/><animate attributeName="cy" from="80" to="15" dur="0.38s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.4s" fill="remove"/></circle>
        <circle cx="80" cy="80" r="2" fill="#c9873e"><animate attributeName="cx" from="80" to="15" dur="0.38s" fill="freeze"/><animate attributeName="cy" from="80" to="145" dur="0.38s" fill="freeze"/><animate attributeName="opacity" from="1" to="0" dur="0.4s" fill="remove"/></circle>
      </svg>`,
    };
