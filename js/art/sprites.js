// ================================================================
// ASHFALL IDLE — art/sprites.js
// All sprite art consolidated: items, monsters, NPCs, skills, pets.
// Merges: sprites.js + sprites-art.js + sprites-skills.js
// ================================================================
// ============================================================
...
Object.assign(GAME_DATA.monsterArt, {
  ...
  the_maiden: `<svg viewBox="0 0 80 80"><ellipse cx="40" cy="52" rx="18" ry="19" fill="#8a1a3a"/><rect x="24" y="36" width="32" height="24" rx="4" fill="#aa2a4a"/><ellipse cx="40" cy="28" rx="14" ry="13" fill="#c83a5a"/><circle cx="34" cy="24" r="4" fill="#ff2266"/><circle cx="46" cy="24" r="4" fill="#ff2266"/><circle cx="34" cy="24" r="2" fill="#ffaacc"/><circle cx="46" cy="24" r="2" fill="#ffaacc"/><path d="M32 32 Q40 36 48 32" stroke="#aa2a4a" stroke-width="2" fill="none"/><rect x="10" y="36" width="10" height="26" rx="4" fill="#8a1a3a"/><rect x="60" y="36" width="10" height="26" rx="4" fill="#8a1a3a"/><path d="M32 52 Q28 60 26 70 M48 52 Q52 60 54 70" stroke="#cc2244" stroke-width="2" fill="none" opacity="0.7"/><ellipse cx="40" cy="58" rx="8" ry="4" fill="#ff2266" opacity="0.3"/></svg>`,

  the_bloat: `<svg viewBox="0 0 80 80"><ellipse cx="40" cy="54" rx="28" ry="20" fill="#4a6a2a"/><ellipse cx="40" cy="46" rx="24" ry="18" fill="#5a8a3a"/><ellipse cx="40" cy="28" rx="16" ry="14" fill="#4a7a2a"/><circle cx="33" cy="24" r="4" fill="#aadd44"/><circle cx="47" cy="24" r="4" fill="#aadd44"/><ellipse cx="33" cy="24" rx="2.5" ry="3" fill="#225a00"/><ellipse cx="47" cy="24" rx="2.5" ry="3" fill="#225a00"/><path d="M34 32 Q40 36 46 32" stroke="#3a6a1a" stroke-width="2" fill="none"/><circle cx="30" cy="48" r="5" fill="#6aaa2a" opacity="0.7"/><circle cx="50" cy="44" r="4" fill="#6aaa2a" opacity="0.6"/><circle cx="40" cy="56" r="6" fill="#5a9a2a" opacity="0.5"/><rect x="30" y="70" width="8" height="8" rx="2" fill="#3a6a1a"/><rect x="42" y="70" width="8" height="8" rx="2" fill="#3a6a1a"/></svg>`,

  shadow_beast: `<svg viewBox="0 0 80 80"><ellipse cx="40" cy="52" rx="20" ry="18" fill="#1a1a2a" opacity="0.9"/><ellipse cx="40" cy="38" rx="16" ry="16" fill="#2a2a3a" opacity="0.85"/><circle cx="34" cy="34" r="5" fill="#5a2ae0"/><circle cx="46" cy="34" r="5" fill="#5a2ae0"/><circle cx="34" cy="34" r="2.5" fill="#aa66ff"/><circle cx="46" cy="34" r="2.5" fill="#aa66ff"/><path d="M32 42 Q40 46 48 42" stroke="#3a1a6a" stroke-width="2" fill="none"/><path d="M24 36 L14 24 L18 22 L26 34" fill="#1a1a2a" opacity="0.8"/><path d="M56 36 L66 24 L62 22 L54 34" fill="#1a1a2a" opacity="0.8"/><rect x="28" y="68" width="10" height="10" rx="2" fill="#1a1a2a"/><rect x="42" y="68" width="10" height="10" rx="2" fill="#1a1a2a"/><circle cx="40" cy="52" r="10" fill="none" stroke="#5a2ae0" stroke-width="1" opacity="0.4" stroke-dasharray="4,3"/></svg>`,

  shadow_warden: `<svg viewBox="0 0 80 80"><ellipse cx="40" cy="52" rx="20" ry="18" fill="#0a0a18"/><rect x="20" y="36" width="40" height="24" rx="4" fill="#151525"/><ellipse cx="40" cy="28" rx="16" ry="14" fill="#0a0a18"/><circle cx="33" cy="24" r="5" fill="#8800ff"/><circle cx="47" cy="24" r="5" fill="#8800ff"/><circle cx="33" cy="24" r="2.5" fill="#dd88ff"/><circle cx="47" cy="24" r="2.5" fill="#dd88ff"/><path d="M32 32 Q40 36 48 32" stroke="#440088" stroke-width="2" fill="none"/><rect x="8" y="36" width="12" height="26" rx="4" fill="#0a0a18"/><rect x="60" y="36" width="12" height="26" rx="4" fill="#0a0a18"/><rect x="28" y="68" width="10" height="10" rx="2" fill="#0a0a18"/><rect x="42" y="68" width="10" height="10" rx="2" fill="#0a0a18"/><circle cx="40" cy="28" r="18" fill="none" stroke="#8800ff" stroke-width="1.5" opacity="0.4"/></svg>`,

  void_warden: `<svg viewBox="0 0 80 80"><ellipse cx="40" cy="52" rx="20" ry="18" fill="#080510"/><rect x="20" y="36" width="40" height="24" rx="4" fill="#100820"/><ellipse cx="40" cy="28" rx="16" ry="14" fill="#0a0518"/><circle cx="33" cy="24" r="5" fill="#6600cc"/><circle cx="47" cy="24" r="5" fill="#6600cc"/><circle cx="33" cy="24" r="2.5" fill="#cc88ff"/><circle cx="47" cy="24" r="2.5" fill="#cc88ff"/><path d="M30 32 Q40 38 50 32" stroke="#440088" stroke-width="2.5" fill="none"/><rect x="6" y="34" width="12" height="28" rx="4" fill="#0a0518"/><rect x="62" y="34" width="12" height="28" rx="4" fill="#0a0518"/><rect x="26" y="68" width="12" height="10" rx="2" fill="#080510"/><rect x="42" y="68" width="12" height="10" rx="2" fill="#080510"/><circle cx="40" cy="28" r="20" fill="none" stroke="#6600cc" stroke-width="2" opacity="0.5" stroke-dasharray="5,4"/><circle cx="40" cy="28" r="12" fill="none" stroke="#cc88ff" stroke-width="1" opacity="0.3"/></svg>`,

  dark_beast: `<svg viewBox="0 0 80 80"><ellipse cx="40" cy="54" rx="22" ry="16" fill="#1a1a1a"/><rect x="18" y="40" width="44" height="20" rx="8" fill="#222"/><ellipse cx="32" cy="34" rx="14" ry="12" fill="#1a1a1a"/><ellipse cx="26" cy="22" rx="6" ry="9" fill="#1a1a1a"/><ellipse cx="36" cy="20" rx="5" ry="8" fill="#1a1a1a"/><circle cx="28" cy="30" r="4" fill="#cc0000"/><circle cx="38" cy="30" r="4" fill="#cc0000"/><path d="M26 38 Q32 41 38 38" stroke="#333" stroke-width="1.5" fill="none"/><path d="M58 50 Q70 44 72 52 Q70 58 58 56" fill="#1a1a1a"/><rect x="22" y="62" width="7" height="14" rx="3" fill="#111"/><rect x="34" y="62" width="7" height="14" rx="3" fill="#111"/><rect x="46" y="62" width="7" height="14" rx="3" fill="#111"/></svg>`,
