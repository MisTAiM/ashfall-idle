...
// ── GWD MONSTERS ────────────────────────────────────────────────
// Minions
GAME_DATA.monsters.goblin_guard={id:'goblin_guard',type:'humanoid',name:'Goblin Guard',hp:400,maxHit:18,attackSpeed:2.4,combatLevel:50,style:'melee',evasion:{melee:20,ranged:15,magic:10},xp:60,gold:{min:5,max:20},alignment:'CE',drops:[{item:'bones',qty:1,chance:1.0}],desc:'Bandos minion.'};
...
GAME_DATA.monsters.spiritual_mage={id:'spiritual_mage',type:'humanoid',name:'Spiritual Mage',hp:550,maxHit:28,attackSpeed:2.2,combatLevel:75,style:'magic',evasion:{melee:25,ranged:30,magic:50},xp:100,gold:{min:15,max:60},alignment:'CE',drops:[{item:'soul_rune',qty:3,chance:0.20},{item:'dragon_bones',qty:1,chance:0.05}],desc:'A possessed mage. Magic attacks.',slayerReq:83};
GAME_DATA.monsters.spiritual_warrior={id:'spiritual_warrior',type:'humanoid',name:'Spiritual Warrior',hp:600,maxHit:25,attackSpeed:2.6,combatLevel:68,style:'melee',evasion:{melee:35,ranged:30,magic:20},xp:90,gold:{min:10,max:50},alignment:'CE',drops:[{item:'big_bones',qty:1,chance:1.0}],desc:'A possessed warrior.',slayerReq:68};

// GWD Bosses
GAME_DATA.monsters.general_graardor={id:'general_graardor',type:'humanoid',name:'General Graardor',hp:5000,maxHit:60,attackSpeed:2.8,combatLevel:280,style:'melee',evasion:{melee:75,ranged:65,magic:40},xp:800,gold:{min:100,max:600},alignment:'CE',drops:[{item:'dragon_bones',qty:3,chance:1.0},{item:'bandos_chestplate',qty:1,chance:0.008},{item:'bandos_tassets',qty:1,chance:0.008},{item:'bandos_boots',qty:1,chance:0.015},{item:'bandos_hilt',qty:1,chance:0.005},{item:'godsword_blade',qty:1,chance:0.01}],desc:'The Bandos General. Massive melee attacks. Uses ranged AoE occasionally.'};
