...
const _newQ = [
  {
    ...
    prereqs:['lost_city'],
    desc:'Grey has received an offer — anonymous, in void-crystal ink, delivered through a dead drop. Someone on the other side of the void wants to negotiate. Grey thinks it\'s a trap. She\'s sending you anyway.',
    objectives:[
    ...
    mechanicsHint:'Void Walkers and Void Crystals are found in the Advanced Areas of the Combat page. Void Crystals drop from Void Walkers — fight enough and you\'ll gather them naturally.',
  },
  {
    id:'blood_moon_rising', name:'Blood Moon Rising', type:'chain', npcId:'dorn', qp:2, difficulty:'Hard',
    prereqs:[],
    desc:'The blood moon comes every seventeen years. The last time it rose, three settlements were wiped out in a single night. Dorn has been preparing for this for years. He needs help with the final preparations — and someone capable enough to survive what comes after dark.',
    objectives:[
    ...
    mechanicsHint:'Lesser Demons appear in the Lesser Abyss combat area. Blood Runes can be bought from the Magic Shop or drop from Ankous and high-level magic monsters.',
  },
  {
    id:'ashen_chronicle', name:'The Ashen Chronicle', type:'chain', npcId:'vex', qp:2, difficulty:'Medium',
    prereqs:['lost_expedition'],
    desc:'Vex has spent twenty years translating fragments of the Ashen Chronicle — a pre-Ashfall record of events the Order of Dawn tried to destroy. The final fragment is in the ruins. So are the things guarding it.',
    objectives:[
    ...
    mechanicsHint:'Ash Golems and Ash Titans appear in Advanced combat areas. Ancient Scrolls are rare drops from high-level Ashfall monsters. Each scroll you gather brings Vex closer to the truth.',
  },
  {
    ...
    objectives:[
      {type:'kill',monster:'ash_titan',qty:3,desc:'Dorn found ancient trial grounds carved into the bedrock beneath the settlement. The inscriptions say only those who defeat a Void Titan in single combat are worthy of the title \'Warborn.\' Dorn believes in titles that mean something.'},
    ...
    mechanicsHint:'Void Titans are powerful enemies in the highest-level combat areas. Super Combat Potions can be bought from the Shop (Potions) or brewed with Herblore. Bring food and prayer potions.',
  },
  {
    id:'frozen_in_time', name:'Frozen in Time', type:'chain', npcId:'grey', qp:2, difficulty:'Hard',
    prereqs:[],
    desc:'Grey found something in a frost-locked vault beneath the northern pass — a person, alive, preserved in ice for what carbon-dating suggests is four hundred years. Before you can speak to them, the Frost Drakes guarding the vault need to be dealt with.',
    objectives:[
    ...
    mechanicsHint:'Frost Drakes appear in cold-climate combat areas. Frost Wraiths are magical creatures found in the same regions. Ice potions (antifire equivalent) can be bought from the Shop.',
  },
  {
    ...
    objectives:[
      {type:'kill',monster:'shadow_beast',qty:25,desc:'A full Silver Order battalion marched into the eastern Ashfall six months ago. No word, no return. Dorn received their sigil carved into a piece of void-touched metal left at the gate. He needs someone to go in and find out what happened.'},
    ...
    mechanicsHint:'Shadow Beasts are found in the eastern Ashfall combat areas. Void Essence drops from Void Emperor Spawns and high-level void-type monsters.',
  },
  {
    ...
    desc:'Vex has located a pre-Ashfall tournament ground still active beneath the settlement — an automated arena that awakens champions one by one. The prize for completing all fifteen rounds is listed in the Chronicle as \'access to the founder\'s vault.\'',
    objectives:[
    ...
    mechanicsHint:'This quest tracks dungeon completions. Open the Dungeons page and enter the Ash Colosseum. You will need strong combat stats and supplies. Bring food, prayer potions, and your best gear.',
  },
  {
    id:'merchant_secret', name:"The Merchant's Secret", type:'chain', npcId:'grey', qp:2, difficulty:'Easy',
    prereqs:[],
    series:'Grey\'s Contacts',
    length:'medium',
    combatLevel:15,
    levelReqs:{thieving:1},
    desc:'Grey has received word that one of her trading contacts — a merchant named Aldric — vanished three days ago on the northern road. His cargo wagon was found abandoned, surrounded by bandit tracks. Whatever Aldric was carrying, the bandits want it badly.',
    lore:'Aldric was smuggling void-touched materials out of the Ashfall under Grey\'s protection. If the bandits crack open that crate, it could destabilize the entire region.',
    objectives:[
      {type:'kill',monster:'bandit',qty:10,desc:'Slay 10 Bandits on the northern road — go to any combat area with Bandits and fight them'},
      {type:'gather',item:'gold_bar',qty:5,desc:'Gather 5 Gold Bars to pay the toll collector guarding the crate — smelt gold ore at a furnace (Mining+Smithing) or buy from the shop'},
    ],
    mechanicsHint:'Gold Bars can be smelted at any furnace using Gold Ore (1 ore = 1 bar, Smithing level 40). You can also buy them from the Smithing shop or find them as monster drops.',
    rewards:{xp:{thieving:5000,attack:3000},items:[{item:'enchant_dust',qty:20},{item:'void_essence',qty:2},{item:'gold_bar',qty:5}],gold:2000,qp:2,unlocks:'Unlocks Grey\'s black market contact for future quests.'},
  },
  {
    ...
    desc:'The Void Emperor doesn\'t communicate — it dominates. So when a fragment of its consciousness reached through the void and left a message in Vex\'s mind, the entire settlement took notice. The message was a warning. Or an invitation. Vex isn\'t sure which is worse.',
    objectives:[
      ...
      {type:'skill_level',skill:'magic',level:80,qty:1,desc:'Reach Magic level 80 — set combat style to Magic on Combat page and fight consistently'},
    ],
    rewards:{xp:{magic:30000,defence:20000,hitpoints:15000},items:[{item:'celestial_robe',qty:1},{item:'void_essence',qty:5}],qp:4},
    mechanicsHint:'Void Emperor Spawns appear in Elite combat areas. Void Crystals drop from them. The level 80 Magic requirement can be met by fighting with Magic style on the Combat page.',
  },
  {
    ...
    desc:'The Celestial Accord is not a weapon you find — it\'s one you forge. Three celestial ingots, bound by void essence, shaped on an infernal anvil, blessed by ancient prayer. Ilyana has the schematics. The question is whether anyone can gather the components without dying first.',
    objectives:[
