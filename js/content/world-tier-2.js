...
const _newQ = [
  {
    id:'void_contract', name:'The Void Contract', type:'chain', npcId:'grey', questPoints:3, difficulty:'Elite',
    prereqs:['lost_city'],
    desc:'A void sage warns of a fracture in reality. Investigate before it is too late.',
    objectives:[
      {type:'kill',target:'void_walker',qty:20,desc:'Slay 20 Void Walkers'},
      {type:'kill',target:'void_titan',qty:5,desc:'Defeat 5 Void Titans'},
      {type:'item',item:'void_crystal',qty:3,desc:'Collect 3 Void Crystals'},
    ],
    rewards:{xp:{magic:15000,attack:10000},items:[{item:'void_crystal',qty:5},{item:'wrath_rune',qty:50}],questPoints:3},
  },
  {
    id:'blood_moon_rising', name:'Blood Moon Rising', type:'chain', npcId:'dorn', questPoints:2, difficulty:'Hard',
    prereqs:[],
    desc:'On the night of the blood moon, demons surge through in greater numbers. Help seal the rift.',
    objectives:[
      {type:'kill',target:'lesser_demon',qty:30,desc:'Slay 30 Lesser Demons'},
      {type:'kill',target:'demon',qty:15,desc:'Slay 15 Demons'},
      {type:'kill',target:'demon_lord',qty:1,desc:'Defeat the Demon Lord'},
    ],
    rewards:{xp:{attack:12000,strength:12000,defence:8000},items:[{item:'infernal_bar',qty:5},{item:'dragon_longsword',qty:1}],questPoints:2},
  },
  {
    id:'ashen_chronicle', name:'The Ashen Chronicle', type:'chain', npcId:'vex', questPoints:2, difficulty:'Medium',
    prereqs:['lost_expedition'],
    desc:'Collect ancient lore tablets to unlock the Chronicle of the First Ash.',
    objectives:[
      {type:'item',item:'ash_rune',qty:50,desc:'Collect 50 Ash Runes'},
      {type:'kill',target:'ash_golem',qty:20,desc:'Destroy 20 Ash Golems'},
      {type:'kill',target:'elder_ash_golem',qty:3,desc:'Destroy 3 Elder Ash Golems'},
    ],
    rewards:{xp:{mining:8000,magic:10000,runecrafting:5000},items:[{item:'ash_rune',qty:200},{item:'elder_core',qty:1}],questPoints:2},
  },
  {
    id:'titans_trial', name:"Titan's Trial", type:'chain', npcId:'dorn', questPoints:4, difficulty:'Master',
    prereqs:['void_contract'],
    desc:"The Ash Titans have awoken. Defeat three and claim the Titan's Mark.",
    objectives:[
      {type:'kill',target:'ash_titan',qty:3,desc:'Defeat 3 Ash Titans'},
      {type:'item',item:'titan_shard',qty:3,desc:'Collect 3 Titan Shards'},
    ],
    rewards:{xp:{attack:25000,strength:25000,hitpoints:15000},items:[{item:'titan_shard',qty:5},{item:'celestial_ingot',qty:1}],questPoints:4},
  },
  {
    id:'frozen_in_time', name:'Frozen in Time', type:'chain', npcId:'grey', questPoints:2, difficulty:'Hard',
    prereqs:[],
    desc:'A ranger has been frozen in magical ice for decades. Find a way to free them.',
    objectives:[
      {type:'kill',target:'frost_wraith',qty:20,desc:'Clear 20 Frost Wraiths'},
      {type:'item',item:'wrath_rune',qty:10,desc:'Collect 10 Wrath Runes for the dispel'},
      {type:'kill',target:'frost_drake',qty:5,desc:'Defeat 5 Frost Drakes'},
    ],
    rewards:{xp:{magic:12000,ranged:10000},items:[{item:'twisted_bow',qty:1}],questPoints:2},
  },
  {
    id:'lost_legion', name:'The Lost Legion', type:'chain', npcId:'dorn', questPoints:2, difficulty:'Medium',
    prereqs:['goblin_problem'],
    desc:"An entire legion vanished in the Shadow Realm. Their spirits are restless.",
    objectives:[
      {type:'kill',target:'shadow_beast',qty:25,desc:'Destroy 25 Shadow Beasts'},
      {type:'kill',target:'shadow_archer',qty:15,desc:'Destroy 15 Shadow Archers'},
    ],
    rewards:{xp:{attack:8000,strength:8000,defence:8000},items:[{item:'shadow_blade',qty:1}],questPoints:2},
  },
  {
    id:'champions_gauntlet', name:"Champion's Gauntlet", type:'chain', npcId:'vex', questPoints:3, difficulty:'Elite',
    prereqs:['blood_moon_rising','frozen_in_time'],
    desc:'Prove mastery of all three combat styles before the Grand Tournament.',
    objectives:[
      {type:'stat',stat:'attack',qty:70,desc:'Reach level 70 Attack'},
      {type:'stat',stat:'ranged',qty:70,desc:'Reach level 70 Ranged'},
      {type:'stat',stat:'magic',qty:70,desc:'Reach level 70 Magic'},
    ],
    rewards:{xp:{attack:20000,ranged:20000,magic:20000},items:[{item:'void_ring',qty:1},{item:'celestial_helm',qty:1}],questPoints:3},
  },
  {
    id:'merchant_secret', name:"The Merchant's Secret", type:'chain', npcId:'grey', questPoints:1, difficulty:'Easy',
    prereqs:[],
    desc:'A merchant vanished on the road. Their cargo of rare materials could be dangerous.',
    objectives:[
      {type:'kill',target:'bandit',qty:10,desc:'Clear 10 bandits from the road'},
      {type:'item',item:'gold_bar',qty:5,desc:'Pay the toll to open the crate'},
    ],
    rewards:{xp:{thieving:3000,attack:2000},items:[{item:'enchant_dust',qty:20},{item:'void_essence',qty:1}],questPoints:1},
  },
  {
    id:'void_emperors_warning', name:"Void Emperor's Warning", type:'chain', npcId:'vex', questPoints:4, difficulty:'Master',
    ...
    objectives:[
      {type:'kill',target:'void_emperor_spawn',qty:10,desc:"Destroy 10 Void Emperor's Spawns"},
      {type:'item',item:'void_crystal',qty:10,desc:'Collect 10 Void Crystals for the ward ritual'},
      {type:'stat',stat:'magic',qty:80,desc:'Reach level 80 Magic'},
    ],
    rewards:{xp:{magic:30000,defence:20000,hitpoints:15000},items:[{item:'celestial_robe',qty:1},{item:'void_essence',qty:5}],questPoints:4},
  },
  {
    id:'celestial_accord', name:'The Celestial Accord', type:'chain', npcId:'dorn', questPoints:5, difficulty:'Grandmaster',
    ...
    objectives:[
      {type:'kill',target:'ash_titan',qty:5,desc:'Defeat 5 Ash Titans for their essence'},
      {type:'kill',target:'demon_lord',qty:3,desc:'Defeat 3 Demon Lords'},
      {type:'kill',target:'void_emperor_spawn',qty:20,desc:"Destroy 20 Void Emperor's Spawns"},
      {type:'item',item:'celestial_ingot',qty:5,desc:'Forge 5 Celestial Ingots'},
    ],
    rewards:{xp:{attack:50000,strength:50000,magic:50000,smithing:30000},items:[{item:'celestial_blade',qty:1},{item:'celestial_body',qty:1},{item:'celestial_legs',qty:1}],questPoints:5},
  },
];
