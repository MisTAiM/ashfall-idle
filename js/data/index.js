// ================================================================
// ASHFALL IDLE — data/index.js
// Core GAME_DATA object. Skills, monsters, areas, dungeons, recipes,
// factions, prayer, shop, thieving, farming, runecrafting, prestige.
// This is the primary data file — loads before all others.
// Source: data.js (main)
// ================================================================
// ============================================================
...
const GAME_DATA = {
  ...
  items: (() => {
    ...
    // ESSENCES FOR MAGIC RUNE CRAFTING
    add('essence_of_mind',   {name:'Mind Essence',   type:'resource',subtype:'essence', sellPrice:15,  sprite:'essence-purple', desc:'Ethereal essence of thought. Used to craft Mind runes.'});
    add('essence_of_air',    {name:'Air Essence',    type:'resource',subtype:'essence', sellPrice:18,  sprite:'essence-blue',   desc:'Swift essence of wind. Used to craft Air runes.'});
    add('essence_of_water',  {name:'Water Essence',  type:'resource',subtype:'essence', sellPrice:20,  sprite:'essence-cyan',   desc:'Flowing essence of water. Used to craft Water runes.'});
    add('essence_of_earth',  {name:'Earth Essence',  type:'resource',subtype:'essence', sellPrice:22,  sprite:'essence-brown',  desc:'Grounded essence of stone. Used to craft Earth runes.'});
    add('essence_of_fire',   {name:'Fire Essence',   type:'resource',subtype:'essence', sellPrice:25,  sprite:'essence-red',    desc:'Burning essence of flame. Used to craft Fire runes.'});
    add('essence_of_body',   {name:'Body Essence',   type:'resource',subtype:'essence', sellPrice:28,  sprite:'essence-gold',   desc:'Living essence of flesh. Used to craft Body runes.'});
    add('essence_of_chaos',  {name:'Chaos Essence',  type:'resource',subtype:'essence', sellPrice:35,  sprite:'essence-red',    desc:'Volatile essence of chaos. Used to craft Chaos runes.'});
    add('essence_of_ancient',{name:'Ancient Essence',type:'resource',subtype:'essence', sellPrice:50,  sprite:'essence-purple', desc:'Timeless essence of ages. Used to craft Ancient runes.'});
  ...
  recipes: {
    ...
    fletching: [
      {id:'fletch_bronze_arrows',name:'Bronze Arrows (15)', category:'Arrows',level:1, xp:40, time:2.0,input:[{item:'oak_log',qty:1},{item:'bronze_bar',qty:1}], output:{item:'bronze_arrows',qty:15}},
      {id:'fletch_iron_arrows',  name:'Iron Arrows (15)',   category:'Arrows',level:15,xp:100, time:2.5,input:[{item:'oak_log',qty:1},{item:'iron_bar',qty:1}],   output:{item:'iron_arrows',qty:15}},
      {id:'fletch_steel_arrows', name:'Steel Arrows (15)',  category:'Arrows',level:30,xp:200, time:3.0,input:[{item:'willow_log',qty:1},{item:'steel_bar',qty:1}],output:{item:'steel_arrows',qty:15}},
      {id:'fletch_mithril_arrows',name:'Mithril Arrows (15)',category:'Arrows',level:45,xp:360,time:3.0,input:[{item:'maple_log',qty:1},{item:'mithril_bar',qty:1}],output:{item:'mithril_arrows',qty:15}},
      {id:'fletch_adamant_arrows',name:'Adamant Arrows (15)',category:'Arrows',level:60,xp:640,time:3.5,input:[{item:'yew_log',qty:1},{item:'adamant_bar',qty:1}],output:{item:'adamant_arrows',qty:15}},
      {id:'fletch_oak_shortbow', name:'Oak Shortbow (Quick)',      category:'Quick Bows',level:5, xp:60, time:3.5,input:[{item:'oak_log',qty:2},{item:'bowstring',qty:1}],    output:{item:'oak_shortbow',qty:1}},
      {id:'fletch_willow_bow',   name:'Willow Shortbow (Quick)',   category:'Quick Bows',level:20,xp:160, time:4.0,input:[{item:'willow_log',qty:2},{item:'bowstring',qty:1}], output:{item:'willow_shortbow',qty:1}},
      {id:'fletch_maple_bow',    name:'Maple Shortbow (Quick)',    category:'Quick Bows',level:35,xp:320, time:4.5,input:[{item:'maple_log',qty:3},{item:'bowstring',qty:1}],  output:{item:'maple_shortbow',qty:1}},
      {id:'fletch_yew_bow',      name:'Yew Longbow (Quick)',       category:'Quick Bows',level:50,xp:600,time:5.0,input:[{item:'yew_log',qty:3},{item:'bowstring',qty:1}],    output:{item:'yew_longbow',qty:1}},
      {id:'fletch_elder_bow',    name:'Elder Shortbow (Quick)',    category:'Quick Bows',level:65,xp:1120,time:6.0,input:[{item:'elder_log',qty:4},{item:'bowstring',qty:1}],   output:{item:'elder_shortbow',qty:1}},
      {id:'fletch_ashwood_bow',  name:'Ashwood Shortbow (Quick)', category:'Quick Bows',level:78,xp:1800,time:7.0,input:[{item:'ash_log',qty:5},{item:'bowstring',qty:1}],    output:{item:'ashwood_bow',qty:1}},
    ],
    crafting: [
  ...
  monsters: {
    chicken:      {id:'chicken',     name:'Chicken',       hp:25,  maxHit:3,  attackSpeed:2.8,combatLevel:1, style:'melee', evasion:{melee:5, ranged:5, magic:5}, xp:20,  gold:{min:0,max:2},  alignment:'NN',drops:[{item:'feather',qty:1,chance:0.50},{item:'bones',qty:1,chance:1.0},{item:'essence_of_mind',qty:1,chance:0.10}]},
    rat:          {id:'rat',         name:'Giant Rat',     hp:40,  maxHit:5,  attackSpeed:2.6,combatLevel:3, style:'melee', evasion:{melee:8, ranged:8, magic:5}, xp:32,  gold:{min:1,max:5},  alignment:'CN',drops:[{item:'bones',qty:1,chance:1.0},{item:'leather',qty:1,chance:0.30},{item:'essence_of_mind',qty:1,chance:0.15}]},
    goblin:       {id:'goblin',type:'humanoid',      name:'Goblin',        hp:60,  maxHit:8,  attackSpeed:2.6,combatLevel:5, style:'melee', evasion:{melee:12,ranged:10,magic:8}, xp:48, gold:{min:3,max:12}, alignment:'CE',drops:[{item:'bones',qty:1,chance:1.0},{item:'bronze_sword',qty:1,chance:0.05},{item:'bronze_shield',qty:1,chance:0.05},{item:'essence_of_air',qty:1,chance:0.18}]},
    skeleton:     {id:'skeleton',    name:'Skeleton',      hp:100, maxHit:12, attackSpeed:2.4,combatLevel:10,style:'melee', evasion:{melee:18,ranged:15,magic:10},xp:72, gold:{min:5,max:20}, alignment:'NE',drops:[{item:'bones',qty:2,chance:1.0},{item:'iron_sword',qty:1,chance:0.05},{item:'essence_of_water',qty:1,chance:0.20}]},
    bandit:       {id:'bandit',type:'humanoid',      name:'Bandit',        hp:150, maxHit:18, attackSpeed:2.4,combatLevel:15,style:'melee', evasion:{melee:25,ranged:20,magic:15},xp:100, gold:{min:10,max:40},alignment:'CN',drops:[{item:'bones',qty:1,chance:1.0},{item:'iron_plate',qty:1,chance:0.03},{item:'iron_helm',qty:1,chance:0.05},{item:'leather',qty:1,chance:0.30},{item:'essence_of_earth',qty:1,chance:0.22}]},
    wolf:         {id:'wolf',        name:'Dire Wolf',     hp:200, maxHit:22, attackSpeed:2.2,combatLevel:20,style:'melee', evasion:{melee:30,ranged:25,magic:15},xp:128, gold:{min:8,max:30}, alignment:'NN',drops:[{item:'bones',qty:1,chance:1.0},{item:'wolf_pelt',qty:1,chance:0.40},{item:'leather',qty:2,chance:0.40},{item:'essence_of_fire',qty:1,chance:0.25}]},
    troll:        {id:'troll',type:'humanoid',       name:'Troll',         hp:350, maxHit:30, attackSpeed:3.0,combatLevel:28,style:'melee', evasion:{melee:35,ranged:30,magic:20},xp:180, gold:{min:15,max:60},alignment:'CE',drops:[{item:'big_bones',qty:1,chance:1.0},{item:'steel_plate',qty:1,chance:0.03},{item:'iron_ore',qty:2,chance:0.15},{item:'essence_of_body',qty:1,chance:0.28}]},
    dark_mage:    {id:'dark_mage',type:'humanoid',   name:'Dark Mage',     hp:280, maxHit:35, attackSpeed:2.6,combatLevel:32,style:'magic', evasion:{melee:15,ranged:20,magic:45},xp:220, gold:{min:20,max:80},alignment:'NE',drops:[{item:'bones',qty:1,chance:1.0},{item:'chaos_rune',qty:5,chance:0.20},{item:'mystic_staff',qty:1,chance:0.02},{item:'mystic_robe',qty:1,chance:0.03},{item:'essence_of_chaos',qty:1,chance:0.30}]},
    shadow_archer:{id:'shadow_archer',type:'humanoid',name:'Shadow Archer',hp:320, maxHit:32, attackSpeed:2.2,combatLevel:35,style:'ranged',evasion:{melee:20,ranged:40,magic:25},xp:240, gold:{min:20,max:70},alignment:'CE',drops:[{item:'bones',qty:1,chance:1.0},{item:'steel_arrows',qty:10,chance:0.30},{item:'maple_shortbow',qty:1,chance:0.03},{item:'studded_body',qty:1,chance:0.04},{item:'essence_of_body',qty:1,chance:0.26}]},
    ogre:         {id:'ogre',type:'humanoid',        name:'Ogre',          hp:500, maxHit:40, attackSpeed:3.2,combatLevel:40,style:'melee', evasion:{melee:40,ranged:35,magic:25},xp:300, gold:{min:25,max:100},alignment:'CE',drops:[{item:'big_bones',qty:1,chance:1.0},{item:'mithril_ore',qty:2,chance:0.10},{item:'hard_leather',qty:1,chance:0.20},{item:'essence_of_ancient',qty:1,chance:0.25}]},
...
GAME_DATA.thievingTargets = [
  ...
  {id:'pickpocket_man',     name:'Man',           level:1,  xp:8,   time:4.2, stunChance:0.20, stunTime:3,  gold:{min:1,max:10},
  ...
  {id:'pickpocket_farmer',  name:'Farmer',        level:10, xp:15,  time:4.9, stunChance:0.25, stunTime:4,  gold:{min:5,max:25},
  ...
  {id:'pickpocket_warrior', name:'Warrior',       level:25, xp:35,  time:5.6, stunChance:0.30, stunTime:5,  gold:{min:15,max:60},
  ...
  {id:'pickpocket_rogue',   name:'Rogue',         level:32, xp:50,  time:5.6, stunChance:0.30, stunTime:5,  gold:{min:20,max:80},
  ...
  {id:'pickpocket_guard',   name:'Guard',         level:40, xp:70,  time:6.3, stunChance:0.35, stunTime:5,  gold:{min:25,max:100},
  ...
  {id:'pickpocket_merchant',name:'Wealthy Merchant',level:50,xp:100,time:6.3, stunChance:0.35, stunTime:6,  gold:{min:40,max:200},
  ...
  {id:'pickpocket_paladin', name:'Paladin',       level:60, xp:150, time:7.0, stunChance:0.40, stunTime:6,  gold:{min:50,max:250},
  ...
  {id:'pickpocket_knight',  name:'Knight',        level:75, xp:220, time:7.0, stunChance:0.45, stunTime:7,  gold:{min:80,max:300},
  ...
  {id:'pickpocket_noble',   name:'Noble',         level:55, xp:160, time:6.3, stunChance:0.38, stunTime:6,  gold:{min:60,max:200},
   loot:[{item:'blood_seed',qty:1,chance:0.15},{item:'ruby',qty:1,chance:0.05},{item:'sapphire',qty:1,chance:0.08}],
   stunDmgBase:7, angerRate:0.22, combatTarget:'black_knight', portrait:'🎩', desc:'A haughty noble. Carries a hefty purse and personal guards.'},
  {id:'pickpocket_king',    name:'King',          level:90, xp:350, time:7.7, stunChance:0.50, stunTime:8,  gold:{min:150,max:500},
  ...
  // ── MARKET STALLS ────────────────────────────────────────
  {id:'steal_cake',    name:'Cake Stall',  level:5,  xp:10,  time:3.5, stunChance:0.15, stunTime:3,  gold:{min:0,max:0},
  ...
  {id:'steal_silk',    name:'Silk Stall',  level:20, xp:25,  time:4.2, stunChance:0.25, stunTime:4,  gold:{min:10,max:30},
  ...
  {id:'steal_gem',     name:'Gem Stall',   level:45, xp:80,  time:5.6, stunChance:0.40, stunTime:6,  gold:{min:0,max:0},
  ...
  {id:'steal_magic',   name:'Magic Stall', level:65, xp:150, time:6.3, stunChance:0.45, stunTime:7,  gold:{min:0,max:0},
  ...
  {id:'steal_dragonry',name:'Dragon Stall',level:85, xp:300, time:7.0, stunChance:0.50, stunTime:8,  gold:{min:0,max:0},
