// ================================================================
// ASHFALL IDLE — data/quests.js
// All quest definitions. One schema. One file.
// prereqs:[], npcId:, qty on all objectives.
// Merges: quests-data.js (staged quests + NPC chain quests from data.js)
// ================================================================
// ================================================================
...
_quest({id:'artillerists_calling',name:"Artillerist's Calling",series:"Artillerist's Path",difficulty:'experienced',length:'long',qp:4,qpRequired:12,combatLevel:45,desc:'Build the legendary Ashforge Cannon.',npcId:'greybeard_tormund',levelReqs:{smithing:35,ranged:40},prereqs:['into_the_wastes'],
stages:[
{id:'start',type:'dialogue',npcId:'greybeard_tormund',dialogue:[{speaker:'greybeard_tormund',text:"Blueprints from the old dwarven kingdoms. A multi-target ranged weapon — the Ashforge Cannon."},{speaker:'player',choices:[{text:"Let's build it.",next:'accept'}]}],giveItems:[{id:'cannon_mould',qty:1}],transitions:{accept:'stage_train'}},
...
rewards:{xp:{smithing:8000,ranged:8000,defence:3000},gold:12000,qp:4,items:[{id:'ashforge_cannon',qty:1},{id:'cannonball',qty:200}],unlocks:'Unlocks: Ashforge Cannon.'}});
