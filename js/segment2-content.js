...
const _fletchPhases = [
  ...
  {id:'carve_oak_sb',    skill:'fletching',level:5,  xp:30,  time:2.5,input:[{item:'oak_log',qty:2}],         output:{item:'oak_shortbow_u',qty:1}},
  {id:'carve_willow_sb', skill:'fletching',level:20, xp:80,  time:3.0,input:[{item:'willow_log',qty:2}],      output:{item:'willow_shortbow_u',qty:1}},
  {id:'carve_maple_sb',  skill:'fletching',level:35, xp:160, time:3.5,input:[{item:'maple_log',qty:3}],       output:{item:'maple_shortbow_u',qty:1}},
  {id:'carve_yew_sb',    skill:'fletching',level:45, xp:240, time:4.0,input:[{item:'yew_log',qty:2}],         output:{item:'yew_shortbow_u',qty:1}},
  {id:'carve_oak_lb',    skill:'fletching',level:10, xp:40,  time:3.0,input:[{item:'oak_log',qty:3}],         output:{item:'oak_longbow_u',qty:1}},
  {id:'carve_willow_lb', skill:'fletching',level:25, xp:120, time:3.5,input:[{item:'willow_log',qty:3}],      output:{item:'willow_longbow_u',qty:1}},
  {id:'carve_maple_lb',  skill:'fletching',level:40, xp:200, time:4.0,input:[{item:'maple_log',qty:4}],       output:{item:'maple_longbow_u',qty:1}},
  {id:'carve_yew_lb',    skill:'fletching',level:50, xp:300, time:4.5,input:[{item:'yew_log',qty:4}],         output:{item:'yew_longbow_u',qty:1}},
  {id:'carve_elder_sb',  skill:'fletching',level:60, xp:450, time:5.0,input:[{item:'elder_log',qty:3}],       output:{item:'elder_shortbow_u',qty:1}},
  {id:'carve_elder_lb',  skill:'fletching',level:65, xp:600, time:5.5,input:[{item:'elder_log',qty:5}],       output:{item:'elder_longbow_u',qty:1}},
  // String phase (unstrung + bowstring → strung bow)
  {id:'string_oak_sb',   skill:'fletching',level:5,  xp:30,  time:2.0,input:[{item:'oak_shortbow_u',qty:1},{item:'bowstring',qty:1}],    output:{item:'oak_shortbow',qty:1}},
  {id:'string_willow_sb',skill:'fletching',level:20, xp:80,  time:2.5,input:[{item:'willow_shortbow_u',qty:1},{item:'bowstring',qty:1}], output:{item:'willow_shortbow',qty:1}},
  {id:'string_maple_sb', skill:'fletching',level:35, xp:160, time:3.0,input:[{item:'maple_shortbow_u',qty:1},{item:'bowstring',qty:1}],  output:{item:'maple_shortbow',qty:1}},
  {id:'string_yew_sb',   skill:'fletching',level:45, xp:240, time:3.5,input:[{item:'yew_shortbow_u',qty:1},{item:'bowstring',qty:1}],   output:{item:'yew_shortbow',qty:1}},
  {id:'string_oak_lb',   skill:'fletching',level:10, xp:40,  time:2.5,input:[{item:'oak_longbow_u',qty:1},{item:'bowstring',qty:1}],    output:{item:'oak_longbow',qty:1}},
  {id:'string_willow_lb',skill:'fletching',level:25, xp:120, time:3.0,input:[{item:'willow_longbow_u',qty:1},{item:'bowstring',qty:1}], output:{item:'willow_longbow',qty:1}},
  {id:'string_maple_lb', skill:'fletching',level:40, xp:200, time:3.5,input:[{item:'maple_longbow_u',qty:1},{item:'bowstring',qty:1}],  output:{item:'maple_longbow',qty:1}},
  {id:'string_yew_lb',   skill:'fletching',level:50, xp:300, time:4.0,input:[{item:'yew_longbow_u',qty:1},{item:'bowstring',qty:1}],   output:{item:'yew_longbow',qty:1}},
  {id:'string_elder_sb', skill:'fletching',level:60, xp:450, time:4.5,input:[{item:'elder_shortbow_u',qty:1},{item:'bowstring',qty:1}], output:{item:'elder_shortbow',qty:1}},
  {id:'string_elder_lb', skill:'fletching',level:65, xp:600, time:5.0,input:[{item:'elder_longbow_u',qty:1},{item:'bowstring',qty:1}],  output:{item:'elder_longbow',qty:1}},
];
